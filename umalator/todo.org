...
* DONE skill hints/cost calculator?
* DONE show skill activations on course chart
* TODO jp localization
* DONE choose motivation
* DONE choose popularity
...
** DONE ocr finished uma screen
** TODO ocr mid-run uma screen
slightly different from above, stats could be hard
** TODO ocr available hints list
from video might provide the best user experience?
* TODO implement stamina/hp consumption
** DONE implement in sim
*** DONE also implement downhills
**** TODO show downhill mode procs on race chart
** DONE chart line
** DONE show % max spurt rate, average excess hp, etc
possibly presented as another "tab" underneath the chart (tabbed with min/max/mean/median basinn gain tab)
** DONE eventually, stamina calculator mode
* DONE unique skill levels
also implement unique scaling in sim
* DONE run compare simulator in worker
should probably not be run on the main UI thread
* TODO select a portion of the track → what activates here?
i.e. reverse lookup skills by proc location

might be better suited to skill-visualizer?

not quite sure what to do in the face of random skills or semi-random skills. maybe the correct solution is to display
and sort by proc % chance.
* TODO cleanup
** DONE build system
...
** TODO fix layout to not be quite so 1080p dependent
for example currently it doesnt work well with DPI scaling even on 1080p
* miscellany
...
** DONE replace skills of the same group when one is added from the bashin chart
** DONE remove skills of the same group on uma2 when running bashin chart
** DONE pass seed to runComparison
...
** DONE potential skill desync issues
...
** DONE seirios ≤4 popularity version is unselectable
...
** DONE skill id 104901111 always drains 100% stamina             :simulator:
...
** DONE seems like a skill desync bug
https://alpha123.github.io/uma-tools/umalator-global/#H4sIAAAAAAAACr1PO2%2BDMBD%2BLzcz2LwS2KJOUZdKGasMFhzEAtvID6Eq4r%2F3DLRpI3Xt9t13d9%2FjDo0J1uG5hZqzkuUJaCfUNKKDumAsAYdIu7TkRVVkh6xKIDh8M%2B4VcYLa24Arc9b%2B5YbNQG%2BdGB2RVjTYYgf1HZQxUSOB3pqgCWYJzCj8De2KHQpn9Aq9VLifihZjKLaQgRI8CpngO%2BljWOAsYywFep7WhDxd03qhpBZQH%2BM0mTk6kAYNffDu62yWrjWKDLcfKzz2HyR6QT2YQKKtJCXd4Gny0ocYBC7RK9hO%2FGJP8BB4pgc5jmT5DjyG5URVjPFvkEVAcYpyB4eNobg5h%2BtWO32q%2FWfhbdwbHx%2BF859983%2Fpe12WT4W4rP5YAgAA
